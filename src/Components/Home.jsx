  ...
  return (
    <section id='home' className=' relative '>
      <div>
            ...
            <div className={`xl:px-12  w-full lg:h-[45rem] xl:h-[60rem]    !grid grid-cols-12   `}  >
              <div className='  lg:col-span-6 col-span-12  ' >
                <div className='   flex justify-start mt-12  md:mt-10 items-center    md:justify-start md:items-center lg:items-start  px-5 flex-col lg:space-y-7 slide-content '>
                  ...
                  <div className='flex space-x-2 font-[900]  lg:text-[50px] xl:text-[70px] text-4xl  '>
                    <h1 className="text-[#ffbd39]">in Islamabad</h1>
                  </div>
              ...
              <div className=" col-span-12  lg:col-span-6  lg:relative w-full lg:w-full h-full    lg:top-0 ">
                <div className=' '>
