                                ...
                                projects.map((item, index) => (
                                    ...
                                    <div key={index} className={`${index === 0 || index === 3 || index === 5 ? "md:col-span-4 col-span-12 mx-4 " : "md:col-span-8 col-span-12 mx-4"}`}>
                                        <div className=" w-full h-72  relative group  ">
                                            ...
                                            <div className='absolute top-0 md:bg-[#ffbd39]  h-full w-full md:scale-0 scale-100 group-hover:scale-100  flex items-center justify-center text-w transition-all  duration-1000   ease-in-out '>
